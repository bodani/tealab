...
#fio -rw=randwrite -ioengine=libaio -direct=1 -thread -numjobs=1  -iodepth=64 -filename=1.data -size=2G   -name=job1 -offset=0MB -bs=4k  -output /tmp/randwrite.json --output-format=json
#fio -rw=randwrite -ioengine=libaio -direct=1 -thread -numjobs=1  -iodepth=64 -filename=1.data -size=2G   -name=job1 -offset=0MB -bs=4k  -output /tmp/randwrite.json --output-format=json
